...
Route::group([
    ...
    Route::crud('ntm-mt', 'NtmMtCrudController');
    Route::crud('ntm-uot', 'NtmUotCrudController');
    Route::crud('ntm-mtt', 'NtmMttCrudController');
    Route::crud('ntm-kmo', 'NtmKmoCrudController');
    Route::crud('ntm-ot', 'NtmOtCrudController');
