...
use App\Http\Requests\NtmKmoRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class NtmKmoCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class NtmKmoCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\NtmKmo::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/ntm-kmo');
        CRUD::setEntityNameStrings('Kadrlar malakasini oshirish', 'Kadrlar malakasini oshirish');
    }
    ...
    {
        CRUD::setValidation(NtmKmoRequest::class);
