...
use App\Http\Requests\NtmMtRequest;
use App\Models\NtmMt;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class NtmMtCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class NtmMtCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\NtmMt::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/ntm-mt');
        CRUD::setEntityNameStrings('Maktabgacha ta`lim', 'Maktabgacha ta`lim');
    }
    ...
    {
        CRUD::setValidation(NtmMtRequest::class);
